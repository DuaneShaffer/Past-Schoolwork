...
-- Requires lexit.lua
-- Structured from rdparser4.lua by Glenn Chappell
...
-- parse_call
-- Parsing function for call statements
-- Function init must be called before this function is called.
function parse_call()
	local good, ast
...
return parseit -- End module parseit
